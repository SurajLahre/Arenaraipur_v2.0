...
import Arena_Brochure from '../components/Arena_Brochure.pdf'
            ...
            <div className='container-fluid text-light d-flex contact-container' >
                <div className='form-inp-ut contact-field'>
                    <form onSubmit={sendEmail}>
                        ...
                        <input type="submit" value="Download Course Details" />
                    </form>
                </div>
            </div>
            <a className='btn btn-outline-dark btn-sm' id='download' style={style1} href={Arena_Brochure} download={Arena_Brochure}>Download</a>
        </>
    )
}
